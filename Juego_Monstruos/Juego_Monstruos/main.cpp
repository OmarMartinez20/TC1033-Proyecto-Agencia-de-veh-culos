...
int main(){
    ...
    while (continua == true){
        ...
        if(opcion == 1){
            ...
            cout<<"Dame los litros de sangre consumidos por Dracula:"<<endl;//Se le pide al usuario otra dato
            ...
            cout<<"Bruja- He realizado "<<bruja1.getEmbrujos()<<" embrujos muy tenebrosos a los niños que no comen bien"<<endl;
            cout<<"\n";
        }
